    ...
    private void initComponents() {
     ...
     private boolean login(String user, String pass) {
        try {
            ...
            ResultSet resultSet = cn.selectQuery("select * from  [LibraryManagement].[dbo].[User] where name='"+user+"' and password='"+pass+"'", argv);
            Vector v = new Vector();
             while (resultSet.next()) {
                    
                    v.add(resultSet.getString("user_id")); // id
                    v.add(resultSet.getString("name"));// fullname
